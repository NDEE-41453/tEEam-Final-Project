...
##                                plt.show()
                                ...
                                if(packet_counter%packets_per_buffer==0):     
                                        ...
                                        final_buffer = [[],[]]
                                        #Note 1: Adjustable variable delay between buffer (adjust to control TX data rate)
                                        #Note 2: There is a minimum delay required for ADALM 2000 to not shut down when both I,Q are in use
